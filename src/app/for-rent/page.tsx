    ...
    <div className="min-h-screen flex flex-col bg-white">
                  ...
                  <Link href={`/properties/${p.id}`} className="hidden sm:flex flex-col bg-white border border-[#f6f6f6] rounded-[20px] p-5 gap-4 transition-shadow">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-5">
                      <div className="relative w-full h-[200px] sm:w-[184px] sm:h-[184px] rounded-[12px] overflow-hidden shrink-0 bg-[#f6f6f6]">
                        <Image src={p.image} alt={p.title} fill className="object-cover" />
                        {/* FOR RENT badge — Figma: top-left 8px inset, pill r=50, 10/600 white uppercase, padding 4/8, bg #FFAE00 */}
                        <span
      ...
      <section className="bg-white">
        <div className="max-w-[1440px] mx-auto px-4 md:px-6 py-4 md:py-6">
          <div className="rounded-[20px] h-[296px] md:h-[464px] flex flex-col items-center justify-center text-white text-center px-4 md:px-6" style={{ background: "linear-gradient(174deg, #75A3C7 0%, #305E82 96%)" }}>
